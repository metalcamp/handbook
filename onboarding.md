...
* [ ] Sign up to [GitHub](GitHub.com) and ask @niteoweb/peopleops (post comment to this issue) to add you to the Niteo organization with your GitHub username on this ticket.
...
Setup for your @teamniteo email address. 
...
### Team Communication
* [ ] Sign up to [Zoom](https://zoom.us/signup), our video conferencing software.
* [ ] Sign up to [Slack](https://join.slack.com/niteoweb/signup), our Team Chat, using the same username as you do on GitHub.
